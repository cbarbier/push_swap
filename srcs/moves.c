...
/*   Updated: 2017/04/20 08:58:34 by cbarbier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				init_handlers(t_ps *ps)
{
	...
	set_handler(h + 8, "rra", ps_move_rra, 0x50);
	set_handler(h + 9, "rrb", ps_move_rrb, 0x30);
	set_handler(h + 10, "rrr", ps_move_rrr, 0x70);
